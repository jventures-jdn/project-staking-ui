    ...
    <Row gutter={24}>
      <Col offset={2} span={20}>
        <Form.Item
          extra={
            <Typography.Text type="secondary">
              System smart contract to upgrade.
            </Typography.Text>
          }
          label="Address"
          name="address"
...
const CreateProposalForm = observer((props: IGenerateThresholdKeyFormProps) => {
  ...
  const handleAddProposal = async (values: {
    ...
    if (values.votingPeriod) {
      const blockTime = chainConfig.blockSec
    ...
    >
      ...
      <Row gutter={24}>
        <Col offset={2} span={20}>
          <Form.Item
            extra={
              <Typography.Text type="secondary">Voting period.</Typography.Text>
            }
            label="Voting Period"
            name="votingPeriod"
          >
            <Select placeholder="Voting peroid">
              <Select.Option value={15 * 60}>15 minutes</Select.Option>
              <Select.Option value={30 * 60}>30 minutes</Select.Option>
              <Select.Option value={60 * 60}>1 hour</Select.Option>
              <Select.Option value={3 * 60 * 60}>3 hour</Select.Option>
              <Select.Option value={6 * 60 * 60}>6 hour</Select.Option>
              <Select.Option value={12 * 60 * 60}>12 hour</Select.Option>
            </Select>
          </Form.Item>
        </Col>
      </Row>
